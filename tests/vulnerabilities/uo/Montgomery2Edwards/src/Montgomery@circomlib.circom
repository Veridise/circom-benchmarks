...
template Edwards2Montgomery() {
    ...
    // Added dummy signal. Without this, we cannot generate a proof.
    // Dummy and dummy_comp is not constrained by input or output, 
    // therefore we do not need to modify the dummy when we modify the input or output.
